'''
Kinematics for Blossom from https://github.com/hrc2/blossom-public
'''
...
def get_motor_pos(ori,accel=[0,0,0]):
    """
...
def calculate_height(m):
    fwd = fwd_kin(m)
    average_motor_angle = np.mean(fwd[0:3])
    b=17.14
    m=0.189
    return average_motor_angle*m+b
